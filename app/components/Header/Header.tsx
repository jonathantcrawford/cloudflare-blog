...
export const Header = () => {
  ...
  const notActiveClasses = ["color-cta-primary", "color-cta-primary-hover"];

  const activeClasses = ["color-cta-primary", "pointer-events-none"];
  ...
  return (
    <div className="w-100p">
      ...
      <div className="m-t-0_5rem font-sans-2 font-size-7 color-text-primary">
        ...
        <a
          className="text-dec-none color-cta-primary color-cta-primary-hover"
          rel="noreferrer"
