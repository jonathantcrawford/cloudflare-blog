...
export const PostHeader = ({info}: any) => {
  return (
    <>
    <NavLink to="/blog" className="ignore-markdown block text-dec-none color-cta-primary color-cta-primary-hover font-sans-3 font-size-5 m-b-1rem">{`< all posts`}</NavLink>
    <div className="bg-color-display-primary color-0 text-dec-none border-radius-2vmn border-width-0_05vmn border-solid border-color-display-primary p-3vmn flex flex-direction-column">
      <span className="font-size-1 font-w-800 font-sans-3 p-b-0_5em">
