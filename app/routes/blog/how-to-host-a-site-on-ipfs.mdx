...
3. Select "Hosting" from the side bar and click "Add New Site"
   <img alt="screenshot_1" src="/static/images/how-to-host-a-site-on-ipfs/screenshot_1.png"/>
4. Connect with Github.
   <img alt="screenshot_2" src="/static/images/how-to-host-a-site-on-ipfs/screenshot_2.png"/>
5. Select a repo.
   <img alt="screenshot_3" src="/static/images/how-to-host-a-site-on-ipfs/screenshot_3.png"/>
6. Select "IPFS" from the Hosting Service dropdown.
   <img alt="screenshot_4" src="/static/images/how-to-host-a-site-on-ipfs/screenshot_4.png"/>
7. Choose the branch you want to deploy when commits are pushed.
   ...
   <img alt="screenshot_5" src="/static/images/how-to-host-a-site-on-ipfs/screenshot_5.png"/>
8. You now have a configured Fleek Project! You can now view an overview of your project as well as a list of deployments and other settings.
   <img alt="screenshot_6" src="/static/images/how-to-host-a-site-on-ipfs/screenshot_6.png"/>
...
<img alt="screenshot_7" src="/static/images/how-to-host-a-site-on-ipfs/screenshot_7.png"/>
