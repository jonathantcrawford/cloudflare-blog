...
What does Remix offer that can't already accomplish with my existing toolset? Server-Side Rendering.
...
### WebSockets > Polling
This is a simple example of a WebSocket. When you click on the button "Open WebSocket", your client attempts to create a new WebSocket at `joncrawford.me/web-socket`.
...
2. Then sends 5 messages at an interval of 500ms. Where each message includes the origin of where the websocket connection was established from and the timestamp of the message.
