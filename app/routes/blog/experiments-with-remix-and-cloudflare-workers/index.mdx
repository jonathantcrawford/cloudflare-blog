...
Once the request to NFTPORT was complete, the Cloudflare Worker injected the contract meta data response into the markup and sent it back to you along with the cookie value.
...
<CookiesDemo/>
*This page is far from optimized and is not an accurate performance representation of the Remix framework.*
